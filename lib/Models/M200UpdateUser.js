...
/**
 * Creates an instance of M200UpdateUser
 */
class M200UpdateUser extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'finishedLessons', realName: 'finishedLessons', array: true },
            { name: 'inProgressLessons', realName: 'inProgressLessons', array: true },
            { name: 'purchasedCourses', realName: 'purchasedCourses', array: true },
            { name: 'purchasedLessons', realName: 'purchasedLessons', array: true },
            { name: 'courses', realName: 'courses' },
            { name: 'orders', realName: 'orders' },
            { name: 'quizes', realName: 'quizes' },
            { name: 'subscriptions', realName: 'subscriptions' },
            { name: 'endedSubscriptions', realName: 'endedSubscriptions' },
        ]);
    }
